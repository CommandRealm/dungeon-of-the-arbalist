...
execute if block 3105 90 189 oak_planks unless entity @e[type=area_effect_cloud,x=3105,y=90,z=189,tag=doorway,distance=..5] run summon area_effect_cloud 3105 90 189.0 {Tags:["doorway","die_between_games","default_door","raycast"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
