...
scoreboard players set @e[type=item,x=3014,y=93,z=174,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 135
scoreboard players set @e[type=item,x=3014,y=93,z=174,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_quantity 2147483647
...
scoreboard players set @e[type=item,x=3022,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 75
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item

loot spawn 3021 94 205 loot game:shop_items/stats/health
scoreboard players set @e[type=item,x=3021,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 90
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item

loot spawn 3020 94 205 loot game:shop_items/utilities/splash_regen_potion
scoreboard players set @e[type=item,x=3020,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 110
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item

loot spawn 3019 94 205 loot game:shop_items/utilities/splash_regen_potion
scoreboard players set @e[type=item,x=3019,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 110
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item
...
scoreboard players set @e[type=item,x=3050,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 100
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item

loot spawn 3049 94 205 loot game:shop_items/health_potion
scoreboard players set @e[type=item,x=3049,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 100
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item

loot spawn 3048 94 205 loot game:shop_items/fishing_rod
scoreboard players set @e[type=item,x=3048,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 90
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item

loot spawn 3047 94 205 loot game:shop_items/throwable_tnt
scoreboard players set @e[type=item,x=3047,y=94,z=205,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 50
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] at @s run function game:shops/initialize_item
...
# I trhink this code was unnecessary and from a different file and I forgot to remove it but I am not 100% confident so we just commenting it out :)
