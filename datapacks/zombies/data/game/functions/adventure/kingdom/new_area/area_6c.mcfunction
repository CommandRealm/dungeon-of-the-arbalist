...
scoreboard players set @e[type=item,x=3140,y=72,z=100,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 135
scoreboard players set @e[type=item,x=3140,y=72,z=100,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_quantity 2147483647
