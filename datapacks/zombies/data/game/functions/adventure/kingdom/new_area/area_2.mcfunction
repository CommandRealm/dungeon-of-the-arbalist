...
##Shops
execute unless score $starting_players game matches 1 unless score $difficulty settings matches 5.. run summon vindicator 3017 78 87 {PersistenceRequired:1b,NoAI:1b,ActiveEffects:[{Id:11b,Duration:10000,Amplifier:126,ShowParticles:false}],HandItems:[],Tags:["shopkeeper","die_between_games"],CustomNameVisible:1b,CustomName:'[{"text":"Jacquelin","color":"gold","bold":true}]'}
