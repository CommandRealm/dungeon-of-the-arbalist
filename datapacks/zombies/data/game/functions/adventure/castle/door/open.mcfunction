...
##Opening 6
execute if entity @s[type=marker,tag=doorway,x=5007,y=88,z=23,distance=..5] run clone 5006 79 20 5007 84 22 5006 88 22
execute if entity @s[type=marker,tag=doorway,x=5007,y=88,z=23,distance=..5] run function game:adventure/castle/new_area/area_6

##Opening 7
execute if entity @s[type=marker,tag=doorway,x=5039,y=89,z=24,distance=..5] run clone 5038 79 20 5039 84 22 5038 88 23
execute if entity @s[type=marker,tag=doorway,x=5039,y=89,z=24,distance=..5] run function game:adventure/castle/new_area/area_7

##Opening 8
execute if entity @s[type=marker,tag=doorway,x=5089,y=90,z=-23,distance=..5] run clone 5088 80 -26 5089 85 -24 5088 89 -24
execute if entity @s[type=marker,tag=doorway,x=5089,y=90,z=-23,distance=..5] run function game:adventure/castle/new_area/area_8

##Opening 9
execute if entity @s[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] run clone 5122 81 -35 5124 87 -33 5124 89 -35
execute if entity @s[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] if block 5104 90 4 polished_blackstone run tag @e[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] remove boss_door
execute if entity @s[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] if block 5104 90 4 polished_blackstone run tag @e[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] add default_door
execute if entity @s[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] if block 5104 90 4 polished_blackstone run function game:adventure/castle/new_area/area_9
execute if entity @s[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] if block 5104 90 4 polished_blackstone run clone 5103 81 5 5105 86 7 5103 89 3


execute if entity @s[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] run clone 5103 81 1 5105 86 3 5103 89 3
execute if entity @s[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] if block 5125 90 -34 polished_blackstone run tag @e[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] remove boss_door
execute if entity @s[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] if block 5125 90 -34 polished_blackstone run tag @e[type=marker,tag=doorway,x=5125,y=90,z=-34,distance=..5] add default_door
execute if entity @s[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] if block 5125 90 -34 polished_blackstone run function game:adventure/castle/new_area/area_9
execute if entity @s[type=marker,tag=doorway,x=5104,y=90,z=4,distance=..5] if block 5125 90 -34 polished_blackstone run clone 5126 81 -35 5128 87 -33 5124 89 -35
...
##area 10
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=37,distance=..5] run clone 4985 69 35 4987 75 36 4983 78 36
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=37,distance=..5] run function game:adventure/castle/new_area/area_10

##area 11 (BOSS)
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=62,distance=..5] run fill 4983 79 62 4985 83 62 nether_bricks replace polished_blackstone
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=62,distance=..5] run fill 4983 79 62 4985 83 62 magma_block replace blackstone
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=62,distance=..5] run fill 4983 79 62 4985 83 62 red_nether_bricks replace chiseled_polished_blackstone
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=62,distance=..5] run scoreboard players set $opened boss 1
execute if entity @s[type=marker,tag=doorway,x=4984,y=79,z=62,distance=..5] run function game:adventure/castle/new_area/area_11
