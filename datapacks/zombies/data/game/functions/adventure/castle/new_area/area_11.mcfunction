...
##Giant
summon giant 4984 69 75 {Invulnerable:1b,Tags:["start_boss_fight_button","die_between_games"],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:100000000,show_particles:false}],PersistenceRequired:1b,Silent:1b,HandItems:[{id:"minecraft:chiseled_nether_bricks",Count:1b},{}]}
