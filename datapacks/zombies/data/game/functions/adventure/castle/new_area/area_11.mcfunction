...
##Giant
summon giant 4984 69 75 {Invulnerable:1b,Tags:["start_boss_fight_button","die_between_games"],ActiveEffects:[{Id:14,Amplifier:0,Duration:100000000,ShowParticles:false}],PersistenceRequired:1b,Silent:1b,HandItems:[{id:"minecraft:chiseled_nether_bricks",Count:1b},{}]}
