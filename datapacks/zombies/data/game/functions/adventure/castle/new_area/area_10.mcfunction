...
##Marking doorways.
summon marker 4984 79 62 {Tags:["doorway","die_between_games","boss_door","openable"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute as @e[type=marker,tag=doorway] at @s unless score @s price_left matches 0.. run scoreboard players set @s price_left 800
