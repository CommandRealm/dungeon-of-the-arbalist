...
##Shops
summon witch 4991 89 42 {PersistenceRequired:1b,NoAI:1b,active_effects:[{id:"minecraft:resistance",duration:10000,amplifier:126,show_particles:false}],HandItems:[],Tags:["shopkeeper","die_between_games"],CustomNameVisible:1b,CustomName:'[{"text":"Mirkha","color":"gold","bold":true}]'}

loot spawn 4993 90 44 loot game:shop_items/stats/health
scoreboard players set @e[type=item,x=4993,y=90,z=44,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 90
...
scoreboard players set @e[type=item,x=4992,y=90,z=44,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 80
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item

loot spawn 4991 90 44 loot game:shop_items/health_potion
scoreboard players set @e[type=item,x=4991,y=90,z=44,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 80
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item


loot spawn 4989 90 42 loot game:shop_items/health_potion
scoreboard players set @e[type=item,x=4989,y=90,z=42,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 80
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item


loot spawn 4989 90 41 loot game:shop_items/utilities/splash_regen_potion
scoreboard players set @e[type=item,x=4989,y=90,z=41,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 100
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item
...
scoreboard players set @e[type=item,x=4971,y=95,z=5,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 60
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item


loot spawn 4972 95 5 loot game:shop_items/stats/revive
scoreboard players set @e[type=item,x=4972,y=95,z=5,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 70
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item

loot spawn 4973 95 5 loot game:shop_items/utilities/throwable_ice
scoreboard players set @e[type=item,x=4973,y=95,z=5,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 30
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item

loot spawn 4975 95 8 loot game:shop_items/utilities/treasure_magnet
scoreboard players set @e[type=item,x=4975,y=95,z=8,distance=..5,limit=1,sort=nearest,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized] item_price 70
execute as @e[type=item,nbt={Item:{tag:{needs_initialization:1b}}},tag=!initialized,sort=nearest,limit=1] at @s run function game:shops/initialize_item
