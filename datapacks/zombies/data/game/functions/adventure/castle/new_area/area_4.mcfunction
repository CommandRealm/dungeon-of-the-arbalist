...
##Shop
summon witch 4978 100 50 {PersistenceRequired:1b,NoAI:1b,active_effects:[{id:"minecraft:resistance",duration:10000,amplifier:126,show_particles:false}],HandItems:[],Tags:["shopkeeper","die_between_games"],CustomNameVisible:1b,CustomName:'[{"text":"Helga","color":"gold","bold":true}]'}
...
##Marking doorways.
summon marker 4963 100 54 {Tags:["doorway","die_between_games","north_south","boss_door","raycast","openable"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute positioned 4963 100 54 as @e[type=marker,tag=doorway,limit=1,sort=nearest] at @s run function game:door/get_price_increment
