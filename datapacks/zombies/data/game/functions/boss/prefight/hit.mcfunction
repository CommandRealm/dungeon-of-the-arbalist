...
title @s[tag=!play_alternate_title] subtitle [{"text":"Drop to ","color":"gray"},{"text":"begin ","color":"#b94a4f"},{"text":"the ","color":"gray"},{"text":"Boss ","color":"#ab0909"},{"text":"Fight","color":"#5a4f4f","bold":false}]
