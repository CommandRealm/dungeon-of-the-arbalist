...
execute as @e[type=area_effect_cloud,tag=upgrade_text,scores={animation=10},tag=lightning_upgrade_text] run data modify entity @s CustomName set value '[{"text":"☄ ","color":"#d2c26c","underlined":true},{"text":"LIGHTNING UPGRADE","bold":true,"color":"#f0d44f"},{"text":" ☄","color":"#d2c26c"}]'
