...
# booster displays
execute as @a[tag=playing,team=!enemy] at @s unless entity @s[nbt={Inventory:[{Slot:12b,tag:{display_booster:1b}},{Slot:13b,tag:{display_booster:1b}},{Slot:14b,tag:{display_booster:1b}},{Slot:21b,tag:{display_booster:1b}},{Slot:22b,tag:{display_booster:1b}},{Slot:23b,tag:{display_booster:1b}}]}] run function game:mechanics/get_display_boosters
