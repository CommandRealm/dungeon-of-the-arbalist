...
execute as @a[tag=playing,tag=filled_hotbar] at @s unless entity @s[nbt={Inventory:[{Slot:10b,id:"minecraft:iron_bars"},{Slot:11b,id:"minecraft:iron_bars"},{Slot:12b,id:"minecraft:iron_bars"},{Slot:13b,id:"minecraft:iron_bars"},{Slot:14b,id:"minecraft:iron_bars"},{Slot:15b,id:"minecraft:iron_bars"},{Slot:16b,id:"minecraft:iron_bars"},{Slot:17b,id:"minecraft:iron_bars"},{Slot:18b,id:"minecraft:iron_bars"},{Slot:19b,id:"minecraft:iron_bars"},{Slot:20b,id:"minecraft:iron_bars"},{Slot:21b,id:"minecraft:iron_bars"},{Slot:22b,id:"minecraft:iron_bars"},{Slot:23b,id:"minecraft:iron_bars"},{Slot:24b,id:"minecraft:iron_bars"},{Slot:25b,id:"minecraft:iron_bars"},{Slot:26b,id:"minecraft:iron_bars"},{Slot:27b,id:"minecraft:iron_bars"},{Slot:28b,id:"minecraft:iron_bars"},{Slot:29b,id:"minecraft:iron_bars"},{Slot:30b,id:"minecraft:iron_bars"},{Slot:31b,id:"minecraft:iron_bars"},{Slot:32b,id:"minecraft:iron_bars"},{Slot:33b,id:"minecraft:iron_bars"},{Slot:34b,id:"minecraft:iron_bars"},{Slot:35b,id:"minecraft:iron_bars"}]}] run function game:mechanics/fill_iron_bars
