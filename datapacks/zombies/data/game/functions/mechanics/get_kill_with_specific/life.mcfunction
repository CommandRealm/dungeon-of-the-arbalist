...
execute if score @s life_kills matches 5.. if score $healthshare modifiers matches 1 unless score $difficulty settings matches 5.. run effect give @a[tag=playing] minecraft:regeneration 3 0 true
