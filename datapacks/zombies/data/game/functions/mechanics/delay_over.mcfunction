...
scoreboard players add @s[scores={boost_quiver=1..},tag=temporary_tag] quiver 5
scoreboard players add @s[scores={boost_quiver=2..},tag=temporary_tag] quiver 5
scoreboard players add @s[scores={boost_quiver=3..},tag=temporary_tag] quiver 5
scoreboard players add @s[scores={boost_quiver=4..},tag=temporary_tag] quiver 5
scoreboard players add @s[scores={boost_quiver=5..},tag=temporary_tag] quiver 5
