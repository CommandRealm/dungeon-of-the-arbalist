...
execute if score $mode settings matches 0 at @e[type=marker,tag=generation_marker,sort=nearest,limit=1] positioned ~-16 ~-16 ~-16 run tag @e[type=marker,tag=zombie_spawnpoint,dx=31,dy=31,dz=31,sort=random,limit=1] add temporary_tag
...
##moving the marker
data modify entity @e[type=marker,tag=needs_adjustments,limit=1] Pos[0] set from entity @e[type=marker,tag=temporary_tag,sort=arbitrary,limit=1] Pos[0]
data modify entity @e[type=marker,tag=needs_adjustments,limit=1] Pos[1] set from entity @e[type=marker,tag=temporary_tag,sort=arbitrary,limit=1] Pos[1]
data modify entity @e[type=marker,tag=needs_adjustments,limit=1] Pos[2] set from entity @e[type=marker,tag=temporary_tag,sort=arbitrary,limit=1] Pos[2]
