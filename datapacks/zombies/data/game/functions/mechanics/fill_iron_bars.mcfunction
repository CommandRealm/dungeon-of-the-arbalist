...
item replace entity @s inventory.3 with iron_bars{display:{Name:'[{"text":""}]'},HideFlags:63}
item replace entity @s inventory.4 with iron_bars{display:{Name:'[{"text":""}]'},HideFlags:63}
item replace entity @s inventory.5 with iron_bars{display:{Name:'[{"text":""}]'},HideFlags:63}
...
item replace entity @s inventory.12 with iron_bars{display:{Name:'[{"text":""}]'},HideFlags:63}
item replace entity @s inventory.13 with iron_bars{display:{Name:'[{"text":""}]'},HideFlags:63}
item replace entity @s inventory.14 with iron_bars{display:{Name:'[{"text":""}]'},HideFlags:63}
