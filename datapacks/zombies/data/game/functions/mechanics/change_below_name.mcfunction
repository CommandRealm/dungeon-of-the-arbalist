...
execute if score $below_name_state game matches 0 run scoreboard objectives setdisplay belowName health
execute if score $below_name_state game matches 1 run scoreboard objectives setdisplay belowName treasure