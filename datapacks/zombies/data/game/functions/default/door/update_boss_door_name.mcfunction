...
loot spawn 0 0 0 loot game:name/boss_door
...
execute as @e[type=area_effect_cloud,tag=temporary_tag] at @s run summon area_effect_cloud ~ ~.25 ~ {Tags:["door_text","die_between_games","upper_door_text"],CustomNameVisible:0b,Age:-2147483648,Duration:-1,WaitTime:-2147483648,CustomName:'[{"text":"The door will become purchasable","color":"#ab0909"}]'}
