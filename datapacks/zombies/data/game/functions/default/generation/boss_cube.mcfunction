...
#Block
execute if score $boss boss matches 4 run setblock ~ ~-16 ~ minecraft:structure_block{metadata:"",mirror:"NONE",ignoreEntities:0b,powered:0b,seed:0L,rotation:"NONE",posX:-16,posY:1,posZ:-16,sizeX:32,sizeY:32,sizeZ:32,showboundingbox:0b,name:"minecraft:cube_boss_updated_forest_essence",id:"minecraft:structure_block",author:"?",mode:"LOAD"}
#Y level of start game button
execute if score $boss boss matches 4 run scoreboard players set $y_level boss 51
...
##Giant
summon giant 2000.0 10 0.0 {Invulnerable:1b,Tags:["start_boss_fight_button","die_between_games"],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:100000000,show_particles:false}],PersistenceRequired:1b,Silent:1b,HandItems:[{id:"minecraft:chiseled_nether_bricks",Count:1b},{}],NoGravity:1b}
