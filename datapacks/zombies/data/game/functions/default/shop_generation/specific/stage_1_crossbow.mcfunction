...
execute if score $rand random matches 1 run function game:default/shop_generation/price/medium_low
...
execute if score $rand random matches 2 run function game:default/shop_generation/price/medium_low
...
execute if score $rand random matches 3 run function game:default/shop_generation/price/medium_low
...
execute if score $rand random matches 4 run function game:default/shop_generation/price/medium_low
...
execute if score $rand random matches 5 run function game:default/shop_generation/price/medium_low
...
execute if score $rand random matches 8 run function game:default/shop_generation/price/medium_low
