...
##Base random number
execute store result score $calculate calculate run loot insert 0 1 0 loot random:medium_low_item_price
...
execute unless score $rand_3 random matches 0..2 store result score $calculate_2 calculate run loot insert 0 1 0 loot random:price_variation
function random:reset_chest
