...
##Opening door 
execute as @e[type=area_effect_cloud,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if score @s price_left matches ..0 run fill 14 82 -28 11 86 -28 air destroy
execute as @e[type=area_effect_cloud,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if score @s price_left matches ..0 run fill 13 83 -27 12 85 -27 air destroy
execute as @e[type=area_effect_cloud,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if score @s price_left matches ..0 run kill @s
##Sound/particle
