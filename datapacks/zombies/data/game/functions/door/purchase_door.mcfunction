...
execute if score @s drop_key matches 1.. as @e[type=marker,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s run scoreboard players operation @s price_increment = @s price_left
...
execute if score $mode settings matches 0 as @e[type=marker,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if entity @s[tag=dark_door] run function game:default/door/late_generation/update_dark_door_name
execute if score $mode settings matches 0 as @e[type=marker,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if entity @s[tag=boss_door] run function game:default/door/late_generation/update_boss_door_name
...
execute if score $mode settings matches 0 as @e[type=marker,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if score @s price_left matches ..0 if entity @s[tag=boss_door] run function game:default/door/boss_door_open

##OPening door adventure
execute if score $mode settings matches 1.. unless entity @e[type=area_effect_cloud,tag=raycast,tag=crossbow_purchasable,distance=..10] as @e[type=marker,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if score @s price_left matches ..0 run function game:adventure/door/open
execute if score $mode settings matches 1 if entity @e[type=area_effect_cloud,tag=raycast,tag=crossbow_purchasable,distance=..10] as @e[type=marker,tag=raycast,tag=doorway,sort=nearest,limit=1] at @s if score @s price_left matches ..0 run function game:boss/fight/stone_monster/crossbow/purchase

##Sound/particle
playsound minecraft:block.note_block.bell master @a ~ ~ ~ 0.5 1.25
execute if score $mode settings matches 0 as @e[type=marker,tag=doorway,sort=nearest,limit=1] at @s if entity @s[tag=east_west] run particle block spruce_planks ~ ~2 ~ 0.75 4 2 0.5 100
execute if score $mode settings matches 0 as @e[type=marker,tag=doorway,sort=nearest,limit=1] at @s if entity @s[tag=north_south] run particle block spruce_planks ~ ~2 ~ 2 4 0.75 0.5 100
