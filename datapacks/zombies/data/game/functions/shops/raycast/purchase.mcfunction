...
execute unless block 0 2 0 minecraft:shulker_box{Items:[{Slot:0b,id:"minecraft:structure_void",Count:1b}]} unless block 0 2 0 minecraft:shulker_box{Items:[{Slot:0b,id:"minecraft:crossbow",Count:1b}]} run loot give @s mine 0 2 0 stone{drop_contents:true}
...
##advancement
execute unless score $difficulty settings matches -1 run advancement grant @s[tag=!tutorial] only advancements:game-shop
