...
execute if entity @e[type=item,tag=temporary_match_0,tag=temporary_match_1,tag=temporary_match_2,tag=temporary_match_3,limit=1,nbt={Item:{id:"minecraft:blue_glazed_terracotta"}}] positioned ^ ^ ^0.5 run summon armor_stand ~ ~ ~ {ArmorItems:[{},{},{},{id:"minecraft:blue_glazed_terracotta",Count:1b}],Invisible:1b,Small:0b,Tags:["throwable_whirlpool","throwable","die_between_games","throwable_get_motion"],Pose:{Head:[0.0f,0.0f,0.0f],RightLeg:[180.0f,0.0f,0.0f],LeftLeg:[180.0f,0.0f,0.0f]},NoBasePlate:1b}
