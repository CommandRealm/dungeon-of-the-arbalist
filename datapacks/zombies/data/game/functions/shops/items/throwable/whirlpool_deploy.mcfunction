...
summon armor_stand ~ ~ ~ {Marker:1b,Invulnerable:1b,Tags:["die_between_games","temporary_tag","on_death_timer","whirlpool"],Invisible:1b,NoBasePlate:1b,ArmorItems:[{},{},{},{id:"minecraft:blue_glazed_terracotta",Count:1b}]}
