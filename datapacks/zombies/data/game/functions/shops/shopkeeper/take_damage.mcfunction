...
execute if score @s attack matches 5..10 at @e[type=area_effect_cloud,tag=generation_marker,limit=1,sort=nearest] positioned ~-16 ~-15 ~-16 as @e[tag=shopkeeper,dx=31,dy=31,dz=31,team=!enemy] at @s run function game:shops/shopkeeper/convert
