...
execute store result score @s calculate run data get entity @s active_effects[{id:"minecraft:water_breathing"}].amplifier 1
execute if score @s calculate matches 0.. if data entity @s active_effects[{id:"minecraft:water_breathing"}].amplifier run function game:enemy/effect/find_effect

##Specific element damage
execute store result score @s calculate run data get entity @s active_effects[{id:"minecraft:mining_fatigue"}].amplifier 1
execute if entity @s[scores={calculate=0..}] if data entity @s active_effects[{id:"minecraft:mining_fatigue"}].amplifier run function game:enemy/elemental_damage

##Extra damage
execute store result score @s calculate run data get entity @s active_effects[{id:"minecraft:hero_of_the_village"}].amplifier 1
