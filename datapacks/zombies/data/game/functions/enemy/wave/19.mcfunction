...
execute if score $rand random matches 20..27 run data modify storage game:enemy SpawnType set value "dota:spider"
execute if score $rand random matches 28..35 run data modify storage game:enemy SpawnType set value "dota:knight"
