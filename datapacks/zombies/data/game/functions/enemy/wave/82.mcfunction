...
execute if score $rand random matches 73..74 run data modify storage game:enemy SpawnType set value "dota:bandit"

execute if score $rand random matches 75..76 run data modify storage game:enemy SpawnType set value "dota:wind_zombie"


execute if score $rand random matches 77..80 run data modify storage game:enemy SpawnType set value "dota:keeper"


execute if score $rand random matches 81..87 run data modify storage game:enemy SpawnType set value "dota:mage"
