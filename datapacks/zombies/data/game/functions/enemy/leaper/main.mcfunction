...
execute as @e[type=zombie,tag=leaper_zombie,scores={attack=..0}] at @s unless data entity @s ActiveEffects[{Id:25}] unless data entity @s ActiveEffects[{Id:2,Amplifier:127b}] run function game:enemy/leaper/leap
