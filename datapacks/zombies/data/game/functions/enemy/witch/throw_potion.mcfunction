...
execute if score $rand random matches 4 run summon potion ~ ~1.75 ~ {Tags:["potion","needs_motion"],Item:{id:"minecraft:lingering_potion",Count:1b,tag:{CustomPotionEffects:[{Id:20,Duration:30,Amplifier:1b}],CustomPotionColor:4473924}},Motion:[0.0d,0.2d,0.0d]}
