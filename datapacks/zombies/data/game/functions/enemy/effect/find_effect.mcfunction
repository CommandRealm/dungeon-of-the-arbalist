...
execute unless entity @s[tag=knight_zombie] unless entity @s[tag=boss] if score @s calculate matches 1 run function game:enemy/effect/air_pushback
execute if score @s calculate matches 2 run function game:enemy/effect/boulder_aoe_damage
execute unless entity @s[tag=knight_zombie] unless entity @s[tag=boss] if score @s calculate matches 3 run function game:enemy/effect/tornado_pushback
...
execute unless entity @s[tag=knight_zombie] unless entity @s[tag=boss] if score @s calculate matches 7 run function game:enemy/effect/cumulonimbus_pushback
...
execute unless entity @s[tag=knight_zombie] unless entity @s[tag=boss] if score @s calculate matches 10 run function game:enemy/effect/atmosphere_pushback
...
execute unless entity @s[tag=knight_zombie] unless entity @s[tag=boss] if score @s calculate matches 22 run function game:enemy/effect/deluge_pushback
execute unless entity @s[tag=knight_zombie] unless entity @s[tag=boss] if score @s calculate matches 23 run function game:enemy/effect/blizzard_pushback
