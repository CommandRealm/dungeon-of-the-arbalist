##Specific elemental code

##Particles
execute if entity @s[scores={calculate=0}] run particle lava ~ ~0.75 ~ 0.25 0.5 0.25 0.15 5
execute if entity @s[scores={calculate=1}] run particle rain ~ ~0.75 ~ 0.25 0.5 0.25 0.25 25
execute if entity @s[scores={calculate=2}] run particle block granite ~ ~0.75 ~ 0.25 0.5 0.25 0.25 8
execute if entity @s[scores={calculate=2}] run particle block polished_granite ~ ~0.75 ~ 0.25 0.5 0.25 0.25 7
execute if entity @s[scores={calculate=2}] run particle block stone ~ ~0.75 ~ 0.25 0.5 0.25 0.25 5
execute if entity @s[scores={calculate=3}] run particle cloud ~ ~0.75 ~ 0.25 0.5 0.25 0.15 5
execute if entity @s[scores={calculate=4}] run particle block ice ~ ~0.75 ~ 0.25 0.5 0.25 0.25 15
