...
title @a[tag=in_plagued_room,tag=playing] title [{"text":" "}]
title @a[tag=in_plagued_room,tag=playing] subtitle ["",{"text":"[","color":"dark_red","bold":true},{"text":"!","color":"red","bold":false},{"text":"]","color":"dark_red","bold":true},{"text":" - ","color":"dark_gray"},{"text":"Exit the room","color":"gold"},{"text":"!","color":"red"}]

# damage
effect give @a[tag=in_plagued_room,tag=playing] wither 1 2 false
