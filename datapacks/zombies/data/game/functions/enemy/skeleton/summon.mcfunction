summon skeleton_horse ~ ~ ~ {Tame:1b,Temper:0,Tags:["miniboss","skeleton_miniboss","die_between_games","needs_initialization","enemy","miniboss_name","skeleton_horse"],Passengers:[{id:"minecraft:skeleton",CustomNameVisible:1b,Tags:["miniboss","skeleton_miniboss","die_between_games","needs_initialization","enemy","miniboss_name","royal_archer"],HandItems:[{id:"minecraft:bow",Count:1b,tag:{Unbreakable:1b}},{}],ArmorItems:[{id:"minecraft:chainmail_boots",Count:1b},{id:"minecraft:chainmail_leggings",Count:1b},{id:"minecraft:chainmail_chestplate",Count:1b},{id:"minecraft:iron_helmet",Count:1b}],Attributes:[{Name:"generic.movement_speed",Base:0.45}]}],Attributes:[{Name:"generic.movement_speed",Base:0.25}],SaddleItem:{}}
