...
execute unless entity @e[type=armor_stand,tag=gamesplay_leaderboard,tag=temporary_tag_2] run tag @e[type=armor_stand,tag=gamesplay_leaderboard,scores={leaderboard_pos=2}] add temporary_tag_2
