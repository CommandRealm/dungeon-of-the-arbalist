...
execute unless entity @e[type=armor_stand,tag=super_hard_leaderboard,tag=temporary_tag_2] run tag @e[type=armor_stand,tag=super_hard_leaderboard,scores={leaderboard_pos=2}] add temporary_tag_2
