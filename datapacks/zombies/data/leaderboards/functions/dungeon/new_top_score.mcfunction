...
execute unless entity @e[type=armor_stand,tag=dungeon_leaderboard,tag=temporary_tag_2] run tag @e[type=armor_stand,tag=dungeon_leaderboard,scores={leaderboard_pos=3}] add temporary_tag_2
