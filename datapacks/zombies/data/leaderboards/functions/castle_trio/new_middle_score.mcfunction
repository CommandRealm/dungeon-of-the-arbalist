...
execute unless entity @e[type=armor_stand,tag=castle_leaderboard3,tag=temporary_tag_2] run tag @e[type=armor_stand,tag=castle_leaderboard3,scores={leaderboard_pos=2}] add temporary_tag_2
