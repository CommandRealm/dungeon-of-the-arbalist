...
execute unless entity @e[type=armor_stand,tag=super_hard_leaderboard2,tag=temporary_tag_2] run tag @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3}] add temporary_tag_2
