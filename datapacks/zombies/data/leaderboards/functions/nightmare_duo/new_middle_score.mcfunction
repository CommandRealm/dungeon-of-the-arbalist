...
execute unless entity @e[type=armor_stand,tag=nightmare_leaderboard2,tag=temporary_tag_2] run tag @e[type=armor_stand,tag=nightmare_leaderboard2,scores={leaderboard_pos=2}] add temporary_tag_2
