...
execute if entity @s[tag=tutorial_2a_2] run kill @e[type=marker,tag=doorway,x=0,y=66,z=0,distance=..500]
execute if entity @s[tag=tutorial_2a_2] run summon marker 13.0 82 -28 {Tags:["doorway","die_between_games","boss_door","raycast"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[tag=tutorial_2a_2] as @e[type=marker,tag=doorway] at @s unless score @s price_left matches 0.. run scoreboard players set @s price_left 1000
