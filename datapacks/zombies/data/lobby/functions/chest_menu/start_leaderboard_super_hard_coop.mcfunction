...
##Setting screen
scoreboard players set @s screen 36
...
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].id set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].tag
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag.display.Name set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] CustomName
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag.clickable set value 1
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag.invalid_click set value 1

execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].id set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].tag
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag.display.Name set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=2},limit=1] CustomName
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag.clickable set value 1
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag.invalid_click set value 1

execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].id set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].tag
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag.display.Name set from entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=3},limit=1] CustomName
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag.clickable set value 1
execute if data entity @e[type=armor_stand,tag=super_hard_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag.invalid_click set value 1
...
##Middle row
item replace block 0 2 0 container.13 with red_concrete_powder{invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"Super Hard ","bold":true,"italic":false,"color":"dark_red"},{"text":"Co-Op","color":"dark_green","bold":true,"italic":false}]'}}


execute if score @s leaderboard_super_hard_wave2 matches 1000000000 run item replace block 0 2 0 container.14 with iron_bars{Enchantments:[{id:"minecraft:aqua_affinity",lvl:1}],invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"- ","color":"gray","italic":false},{"text":"You don\'t have a score yet!","color":"red"}]'}}

scoreboard players operation $calculate calculate = @s leaderboard_super_hard_wave2
execute unless score @s leaderboard_super_hard_wave2 matches 1000000000 run loot replace block 0 2 0 container.14 loot leaderboards:wave_highscore
