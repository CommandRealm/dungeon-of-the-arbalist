...
##Setting screen
scoreboard players set @s screen 42


##Top Row
item replace entity @s enderchest.8 with black_concrete_powder{invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"Nightmare","bold":true,"italic":false,"color":"#423031"}]'}}
