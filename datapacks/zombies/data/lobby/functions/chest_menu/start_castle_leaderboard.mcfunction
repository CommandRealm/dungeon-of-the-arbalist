...
##Middle row
item replace block 0 2 0 container.13 with cracked_stone_bricks{invalid_click:1,clickable:1,HideFlags:63,display:{Name:'[{"text":"Invaded Castle","bold":true,"italic":false,"color":"dark_green"}]'}}
...
execute if score @s castle_score matches 1000000000 run item replace block 0 2 0 container.14 with iron_bars{Enchantments:[{id:"minecraft:aqua_affinity",lvl:1}],invalid_click:1,clickable:1,HideFlags:63,display:{Name:'[{"text":"- ","color":"gray","italic":false},{"text":"You don\'t have a score yet!","color":"red"}]'}}
