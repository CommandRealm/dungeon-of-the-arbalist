...
##Setting screen
scoreboard players set @s screen 39


##Top Row
item replace entity @s enderchest.8 with orange_concrete_powder{invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"Hard","bold":true,"italic":false,"color":"red"}]'}}
