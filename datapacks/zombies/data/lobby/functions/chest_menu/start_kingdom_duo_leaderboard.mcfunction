...
##Setting screen
scoreboard players set @s screen 26
...
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].id set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].tag
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag.display.Name set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] CustomName
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag.clickable set value 1
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:3b}].tag.invalid_click set value 1

execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].id set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].tag
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=2},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag.display.Name set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=2},limit=1] CustomName
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag.clickable set value 1
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:12b}].tag.invalid_click set value 1

execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].id set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].tag
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=3},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag.display.Name set from entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=3},limit=1] CustomName
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag.clickable set value 1
execute if data entity @e[type=armor_stand,tag=kingdom_leaderboard2,scores={leaderboard_pos=1},limit=1] ArmorItems[3].id run data modify block 0 2 0 Items[{Slot:21b}].tag.invalid_click set value 1
...
##Middle row
item replace block 0 2 0 container.13 with warped_wart_block{invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"Corrupted Kingdom ","bold":true,"italic":false,"color":"dark_aqua"},{"text":"Duo","color":"dark_green","bold":true,"italic":false}]'}}


##Getting our time.
tag @s remove kingdom
clear @s tipped_arrow
scoreboard players operation @s run = @s kingdom_score2
...
execute if score @s kingdom_diff2 matches -1 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Training","color":"white","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 0 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Super Easy","color":"dark_green","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 1 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Easy","color":"green","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 2 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Medium","color":"yellow","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 3 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Hard","color":"red","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 4 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Super Hard","color":"dark_red","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 5 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Hardcore","color":"#600011","bold":true,"italic":false}]'
execute if score @s kingdom_diff2 matches 6 run data modify block 0 2 0 Items[{Slot:14b}].tag.display.Lore append value '[{"text":"Nightmare","color":"#423031","bold":true,"italic":false}]'

execute if score @s kingdom_score2 matches 1000000000 run item replace block 0 2 0 container.14 with iron_bars{Enchantments:[{id:"minecraft:aqua_affinity",lvl:1}],invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"- ","color":"gray","italic":false},{"text":"You don\'t have a score yet!","color":"red"}]'}}
