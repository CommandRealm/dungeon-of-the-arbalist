...
##Setting screen
scoreboard players set @s screen 41


##Top Row
item replace entity @s enderchest.8 with brown_concrete_powder{invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"Hardcore","bold":true,"italic":false,"color":"#600011"}]'}}
