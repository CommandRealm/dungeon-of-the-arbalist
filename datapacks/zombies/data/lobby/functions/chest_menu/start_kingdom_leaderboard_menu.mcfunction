...
##Setting screen
scoreboard players set @s screen 22


##Top Row
item replace entity @s enderchest.8 with warped_wart_block{invalid_click:1,clickable:1,HideFlags:255,display:{Name:'[{"text":"Corrupted Kingdom","bold":true,"italic":false,"color":"dark_aqua"}]'}}
