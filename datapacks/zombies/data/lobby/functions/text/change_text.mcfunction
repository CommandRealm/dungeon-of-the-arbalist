...
##Updating our text
setblock 0 10 0 air
execute if entity @s[tag=reverse_state] run setblock 0 10 0 oak_sign{Text1:'[{"text":"","bold":true},{"text":"☣","color":"dark_green","bold":false},{"text":" - ","color":"gray","bold":true},{"nbt":"ArmorItems[3].tag.current","entity":"@e[type=armor_stand,tag=temporary_tag,sort=nearest,limit=1]","interpret":true,"color":"white"},{"nbt":"ArmorItems[3].tag.current_colored","entity":"@e[type=armor_stand,tag=temporary_tag,sort=nearest,limit=1]","interpret":true,"color":"green","underlined":true},{"text":" - ","color":"gray","bold":true},{"text":"☣","color":"dark_green","bold":false}]'} destroy
execute if entity @s[tag=!reverse_state] run setblock 0 10 0 oak_sign{Text1:'[{"text":"","bold":true},{"text":"☣","color":"dark_green","bold":false},{"text":" - ","color":"gray","bold":true},{"nbt":"ArmorItems[3].tag.current_colored","entity":"@e[type=armor_stand,tag=temporary_tag,sort=nearest,limit=1]","interpret":true,"color":"green","underlined":true},{"nbt":"ArmorItems[3].tag.current","entity":"@e[type=armor_stand,tag=temporary_tag,sort=nearest,limit=1]","interpret":true,"color":"white"},{"text":" - ","color":"gray","bold":true},{"text":"☣","color":"dark_green","bold":false}]'} destroy
